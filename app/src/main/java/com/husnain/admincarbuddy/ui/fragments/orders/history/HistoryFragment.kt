package com.husnain.admincarbuddy.ui.fragments.orders.history
...
import com.husnain.admincarbuddy.databinding.FragmentHistoryBinding
...
class HistoryFragment : Fragment() {
    ...
    private fun setUpObserver(){
        vmOrders.completedBookings.observe(viewLifecycleOwner) {
            when (it) {

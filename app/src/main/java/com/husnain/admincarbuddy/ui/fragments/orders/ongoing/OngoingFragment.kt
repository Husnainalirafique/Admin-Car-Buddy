package com.husnain.admincarbuddy.ui.fragments.orders.ongoing
...
import com.husnain.admincarbuddy.databinding.FragmentOngoingBinding
...
class OngoingFragment : Fragment() {
    ...
    private fun setUpObserver() {
        vmOrders.ongoingBookings.observe(viewLifecycleOwner) {
            when (it) {
